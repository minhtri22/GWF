...
class RpcClient:
    def __init__(self, proc: subprocess.Popen[str], evidence_dir: Path):
        ...
        self.protocol_path = evidence_dir / "P5A_D2S2_A1_PREFLIGHT_PROTOCOL_SANITIZED.jsonl"
        self.stderr_path = evidence_dir / "P5A_D2S2_A1_PREFLIGHT_STDERR_HASHES.jsonl"
...
def main() -> int:
    ...
    evidence = {
        "schema": "G2E-P5A-D2S2-A1-NTFS-METADATA-PRETURN-v1",
        "study_id": STUDY_ID,
    ...
    try:
        ...
        client.send({
            ...
            "params": {
                "clientInfo": {
                    "name": "g2e_p5a_d2s2_a1_preflight",
                    "title": "G2E P5A D2-S2 A1 Preflight",
                    "version": "1.0.0",
                },
        ...
        out = evidence_dir / "P5A_D2S2_A1_LOCAL_PRETURN_PREFLIGHT.json"
        out.write_text(
