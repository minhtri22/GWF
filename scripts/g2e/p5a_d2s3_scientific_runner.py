...
def validate_r2_evidence(path: Path) -> dict:
    ...
    checks = {
        ...
        "study": evidence.get("study_id") == STUDY_ID,
        "attempt": evidence.get("attempt_id") == ATTEMPT_ID,
...
def main() -> int:
    ...
    marker_path = evidence_dir / "P5A_D2S3_TURN_START_SENT.marker"

    evidence = {
        "schema": "G2E-P5A-D2S3-SCIENTIFIC-RUNNER-v1",
        "study_id": STUDY_ID,
    ...
    try:
        ...
        out = evidence_dir / "P5A_D2S3_SCIENTIFIC_RUNNER_EVIDENCE.json"
        out.write_text(
